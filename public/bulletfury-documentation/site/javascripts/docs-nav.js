  ...
  const NAV_GROUPS = [
    ...
    },
    {
      ...
      children: [
        ...
        { label: "Import the Sample Scene", href: "/getting-started/setup-and-first-spawn/#2-import-the-sample-scene" },
        { label: "Create a spawner object", href: "/getting-started/setup-and-first-spawn/#3-create-a-spawner-object" },
        { label: "Make it visible", href: "/getting-started/setup-and-first-spawn/#4-make-it-visible" },
        { label: "Configure the basics", href: "/getting-started/setup-and-first-spawn/#5-configure-the-basics" },
        { label: "Fire", href: "/getting-started/setup-and-first-spawn/#6-fire" },
        { label: "Exploring Modules", href: "/getting-started/setup-and-first-spawn/#exploring-modules" },
        { label: "Advanced Spawn Settings", href: "/getting-started/setup-and-first-spawn/#advanced-spawn-settings" },
        { label: "Manual spawning", href: "/getting-started/setup-and-first-spawn/#manual-spawning" },
        { label: "Controlling the simulation", href: "/getting-started/setup-and-first-spawn/#controlling-the-simulation" },
    ...
    },
    {
      title: "API Reference",
      children: [
        { label: "BulletSpawner", href: "/api-reference/#bulletspawner" },
        { label: "Module interfaces", href: "/api-reference/#module-interfaces-and-contracts" },
        { label: "Core config types", href: "/api-reference/#core-configuration-types" },
        { label: "Bullet data model", href: "/api-reference/#bullet-data-model-bulletfurydata" },
        { label: "Rendering APIs", href: "/api-reference/#rendering-and-shared-render-data" },
        { label: "Built-in modules", href: "/api-reference/#built-in-free-modules-bulletfurymodules" },
        { label: "Utilities", href: "/api-reference/#commonrandom-utility-apis" },
        { label: "Best practices", href: "/api-reference/#best-practices-and-pitfalls" },
      ],
    },
    {
      title: "Free Modules",
